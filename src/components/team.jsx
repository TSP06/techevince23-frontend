...
export default function Team() {
  return (
    ...
    <div className=" flex flex-col">
        <div className="mt-12">
            <p className="flex flex-col items-start text-3xl font-semibold self-stretch mx-14 -mb-3 top-5 left-14 z-10" style={{fontFamily: 'Clash Display Variable'}}>Core Team</p>
            <div className="rectangle bg-customBlue-100 h-3 w-36 mx-28 top-11 left-28"></div>
        </div> 

        <div className='grid justify-items-center grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-12 w-full mb-56 mt-12'>
        {team && team.map(item =>{
            return(
